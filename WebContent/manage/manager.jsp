...
<table width="92%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="16%"><a href="#" onClick="window.open('manager_add.jsp','','width=292,height=250')">添加管理员信息</a> </td>
  </tr>
</table>
<table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  ...
  <tr>
	...
	<td>
		&nbsp;<a href="pwd_Modify.jsp?id=<%=list.get(i).getId()%>" paramId="id" paramName="manager" paramProperty="ID" >修改</a>
	</td>
    <td >
    	&nbsp;<a href="delete_manager.jsp?id=<%=list.get(i).getId()%>" paramId="id" paramName="manager" paramProperty="ID" >删除</a>
	</td>
  </tr>
  <%} %>
</table></td>
